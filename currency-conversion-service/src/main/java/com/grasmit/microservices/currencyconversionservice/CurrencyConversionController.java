package com.grasmit.microservices.currencyconversionservice;
...
public class CurrencyConversionController {
	...
	public CurrencyConversion calcuclateCurrencyConversion(@PathVariable String from, @PathVariable String to, 
	...
	public CurrencyConversion calcuclateCurrencyConversionFeign(@PathVariable String from, @PathVariable String to, 
			@PathVariable BigDecimal quantity) {
